...
public class TurretController : MonoBehaviour
{
    ...
    public Transform m_rotateX, m_rotateY;
    ...
    private void RotateTurret(Vector3 p_targetPos)
    {
        ...
        if (Vector3.Angle(m_rotateY.forward, currentTarget) > 150)
        {
            ...
            m_rotateY.Rotate(m_rotateY.up, (currentDistance > 1 ? m_rotationSpeed : currentDistance * m_rotationSpeed) * Mathf.Sign(dirToRotate));
        ...
        //Rotate
        m_rotateX.Rotate(Vector3.right, (currentDistance > 3 ? m_rotationSpeed : currentDistance/3 * m_rotationSpeed) * Mathf.Sign(dirToRotate));
